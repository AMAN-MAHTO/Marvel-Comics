  ...
  body: SingleChildScrollView(
    child: Column(
      ...
      children: [
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Text(
                  event != null && event!.description != null && event!.description!.isNotEmpty
                      ? event!.description!
        ...
        SizedBox(height: 16), // Add some spacing between the description and the heading
        // Event list heading
        Padding(
        ...
        if (dataProvider.eventsList != null)
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 8), // Adjust vertical and horizontal padding
                child: Card(
                  child: ListTile(
